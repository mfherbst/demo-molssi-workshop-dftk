...
# ╔═╡ d45fc478-8fa9-11ef-301e-a36c49674e0b
begin
	using AtomsBuilder
	using DFTK
	using LazyArtifacts
...
# ╔═╡ af6aadcd-a9a8-45da-99c1-5201706bf193
md"""
# Silicon: The hello world of plane-wave DFT
"""

# ╔═╡ 98d15d52-9934-44d6-8374-dc95b5a0a27d
...
# ╔═╡ b1967c74-3d97-4c4c-8951-9567e346032b
setup_threading(n_blas=1)

# ╔═╡ 04433d6e-8c4a-4a6e-9719-69c5559235d5
silicon = attach_psp(bulk(:Si); Si=artifact"pd_nc_sr_pbe_standard_0.4.1_upf/Si.upf");

# ╔═╡ f1b9df55-5185-4004-813f-860ab473d0c6
model = model_PBE(silicon)

# ╔═╡ f5a3617b-c214-49c2-8b86-43cb25892f82
basis = PlaneWaveBasis(model; Ecut=10, kgrid=(2, 2, 2))

# ╔═╡ 2d8c895f-6e7c-4139-9d58-f2ab7ff1e562
...
manifest_format = "2.0"
project_hash = "4aa873119df63b56fe2382a3f28dba13e77898ca"
