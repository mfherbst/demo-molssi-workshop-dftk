...
# ╔═╡ 2c2e14f7-1a63-4544-a048-e6edd2fa10b1
begin
	using PlutoUI
	using LazyArtifacts
	using LinearAlgebra
...
# ╔═╡ 0fa388ee-8f8c-11ef-20ce-95e5d039cafd
md"""
# 2. JuliaMolSim integration
"""
...
# ╔═╡ f1856e6d-2e76-494b-b19f-d3d6b307adbd
md"## Initial structure"

# ╔═╡ b118860a-8191-44ce-9957-f3974adb2561
begin
...
# ╔═╡ 23e870bd-dbd4-4c1f-976e-09b3d881a5eb
md"## Setup calculator
Create an AtomsCalculator-compatible DFTK calculator"
...
md"Compute the potential energy:"
...
[compat]
AtomsBuilder = "~0.1.0"
AtomsCalculators = "~0.2.2"
DFTK = "~0.6.20"
GeometryOptimization = "~0.1.0"
Plots = "~1.40.8"
PlutoUI = "~0.7.60"
"""
...
manifest_format = "2.0"
project_hash = "2d358d5d095f4f85afd06b1df94185b7686fe8d8"
...
[[deps.GeometryOptimization]]
deps = ["AtomsBase", "AtomsCalculators", "DocStringExtensions", "LineSearches", "LinearAlgebra", "Optimization", "OptimizationOptimJL", "PrettyTables", "Printf", "StaticArrays", "TimerOutputs", "Unitful", "UnitfulAtomic"]
git-tree-sha1 = "63a6c76c1aa691f63abd4f58f632b55574b7725c"
...
git-tree-sha1 = "e13a54455c5b30ddeda3ca3a67ed68cd6fb8b250"
